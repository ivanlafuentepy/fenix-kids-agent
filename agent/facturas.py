...
async def manejar_respuesta_factura(
    ...
    if _negativo and (btn_id == "factura_no" or esperando_datos or _menciona_factura):
        ...
        # Nos pasó los datos fiscales (o factura a nombre de otra persona) →
        # guardar el texto LITERAL en FAMILIAS FENIX.FACTURA (el lookup
        # FLIA FENIX RUC lo expone en la factura) y crear el registro.
        if familia_id:
