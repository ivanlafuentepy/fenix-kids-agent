...
| 307 | **Primer contacto del Desafío** — plan completo en `docs/PROXIMA-SESION-DESAFIO.md`: (a) "quiero pagar con tarjeta" cae en el saludo genérico (`lead_menu.py:346` responde por estado, no por contenido), (b) el saludo tiene que contar el campus + foto de La Casona, (c) flujo nuevo "agendar llamada" con aviso al admin | ⏳ Pendiente |
...
| 309 | Definir con Iván las 3 opciones de horario de los botones de "agendar llamada" (sugerido: Ahora · Más tarde hoy · Mañana) | ⏳ Pendiente |
