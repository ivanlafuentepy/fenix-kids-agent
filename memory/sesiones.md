...
|--------|--------------------|-------|-------------|
| primera estación NFC | a3aad9b5-8314-4eb2-b727-20ed718538fb | 2026-07-24/25 | Primera estación física del circuito NFC (quincho: RC522+ESP32, soldado por primera vez, WiFi+POST real, anillo LED). Fix de bug real: cierre de vuelta por NFC nunca acreditaba plata real (solo animaba la TV) — arreglado + extendido al check-in facial (cierra vuelta sola). Piloto de hoy simplificado a 1 estación en Railway (JUEGO_ESTACIONES=quincho). |
